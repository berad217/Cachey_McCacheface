...
// two causes: a long idle gap = you stepped away (avoidable); a short gap =
// the tool compacted or bulk-loaded context (not your reply timing).
const IDLE_GAP_MIN = 60; // gap beyond this (on the 1h tier) = you walked away
